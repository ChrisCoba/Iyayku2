...
'<section class="editoriales"><div class="editorial"><h2>Editorial Innova</h2><p>Editorial Innova es una editorial académica ecuatoriana, fundada y dirigida por profesionales especializados en investigación, que forman parte de la empresa Iyayku Innovación Tecnológica Iyaykutec Cía. Ltda. Esta editorial brinda a la comunidad científica cuatro revistas arbitradas, de acceso abierto, con una periodicidad semestral y un formato de publicación continua. Las revistas son editadas en Ecuador y cubren una amplia variedad de disciplinas.</p><p class="frase-final">¡Innovación que trasciende, ideas que perduran!</p><div class="boton-container"><a href="https://editorialinnova.com/" class="btn-editorial" target="_blank">Visitar Sitio</a></div></div><div class="editorial"><h2>Editorial Sphaera</h2><p>Editorial Sphaera es una editorial académica ecuatoriana, fundada y dirigida por profesionales especializados en investigación, que forman parte de la empresa Iyayku Innovación Tecnológica Iyaykutec Cía. Ltda. Esta editorial brinda a la comunidad científica cuatro revistas arbitradas, de acceso abierto, con una periodicidad semestral y un formato de publicación continua. Las revistas son editadas en Ecuador y cubren una amplia variedad de disciplinas.</p><div class="boton-container"><a href="https://editorialsphaera.com/" class="btn-editorial" target="_blank">Visitar Sitio</a></div></div></section>', 1);
