export function renderPerfil() {
  const html = `
    ...
    <main class="admin-dashboard-main admin-dashboard-main-blanco">
      <!-- Aquí puedes pegar el contenido del dashboard, paneles y formularios tal como en tu perfil.html -->
      <!-- Por ejemplo: -->
      <section class="admin-dashboard-content">
        <div class="admin-dashboard-welcome">
          ¡Bienvenido, Administrador!
        </div>
        <!-- ...el resto de tu HTML de perfil aquí... -->
      </section>
    </main>
    <footer class="footer">
  ...
  // Aquí puedes inicializar los scripts de paneles, formularios, etc. si es necesario
}