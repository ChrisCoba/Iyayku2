export function renderContacto() {
  ...
  // Opcional: cargar dinámicamente el contenido de contacto desde el backend
  // fetch('/api/paginas/contacto/main')
  //   .then(res => res.json())
  //   .then(data => {
  //     document.getElementById('contenido-contacto').innerHTML = data.contenido || '';
  //   });
